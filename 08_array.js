...
console.log(arrayNumbers.indexOf(700));// results -1 which indicates no such element
...
let word = ""; // for printing on one line :  concatenation
for (let index = arrayNums.length-1; index >=0; index--) {
    const element = arrayNums[index];
    word = word + ',' + element; //concatenation
    console.log(element);  
}
console.log(word); //concatenation
